...
consistent_submitters <- readr::read_csv("consistent_submitters_2022_23.csv")

gt::gt(dplyr::slice_head(icb_contacts_fy_projected[["data"]][[1]], n = 5))
# gt::gt(dplyr::slice_head(consistent_submitters, n = 5))
...
add_age_groups <- function(.data) {
  .data |>
    dplyr::mutate(
      ...
      across(age_group_cat, fct_inorder)
    )
}
