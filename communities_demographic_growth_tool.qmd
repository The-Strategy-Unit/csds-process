...
TODO filter only to consistent providers and attended appointments.

Consistent providers: submitted CSDS data each month in 2022-23.
2023-24 data includes mandatory attendance data - all providers in theory
